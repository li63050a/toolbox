        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    if (isRunning) {
                        Text(
                            "$serverInfo · ${if (hasPermission) stringResource(R.string.shizuku_perm_granted) else stringResource(R.string.shizuku_perm_pending)}",
            ...
            Card(Modifier.fillMaxWidth()) {
                Column(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Spacer(Modifier.width(8.dp))
                        Text(
                            stringResource(R.string.shizuku_command_test),
                    ...
                    if (output.isNotEmpty() && output != "执行中...") {
                        Card(
                            Modifier.fillMaxWidth(),
